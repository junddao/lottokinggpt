...
extension StringExtension2 on String? {
  ...
  bool get iaPassword {
    ...
    return CSRegExp.password.hasMatch(this!);
  }

  /// 이메일 확인
  bool get isEmail {
    if (this == null) return false;
    return CSRegExp.email.hasMatch(this!);
  }

  /// 휴대폰 번호 확인
  bool get isPhoneNumber {
    if (this == null) return false;
    return CSRegExp.smartphone.hasMatch(this!);
  }

  /// 휴대폰 번호가 아닌지 확인
  bool get isNotPhoneNumber {
    if (this == null) return false;
    return !CSRegExp.password.hasMatch(this!);
  }
  ...
  bool get isUrl {
    if (this == null) return false;
    return CSRegExp.url.hasMatch(this!);
  }
